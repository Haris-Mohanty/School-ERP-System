      ...
      <div class="row mb-4">
        ...
        <div class="col-md-10 bg-white shadow-sm mt-3 p-4">
          <h5 class="category-h5 mb-3">
            ...
            <i class="fa-solid fa-circle-notch fa-spin d-none student-loader float-end mt-1 text-danger" style="font-size: 20px"></i>
          </h5>
          <hr />
          <!-- form start -->
          <form class="student-form">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <input type="text" name="enrollment" placeholder="Enrollment No." class="enrollment-el form-control">
      ...
      <div class="row">
        ...
        <div class="col-md-10 bg-white p-4 shadow-sm">
          <h5 class="category-h5 mb-3">
            ...
            <i class="fa-solid fa-circle-notch fa-spin student-list-loader d-none float-end mt-1 text-danger" style="font-size: 20px"></i>
          </h5>
          <hr>
          <div class="row">
          <div class="col-md-6">
